...
public class DefaultWorkingDays extends WorkingDays {
    ...
    protected void setupWorkingDays() {
        ...
        this.isWorkingDayMap.put(DayOfWeek.SATURDAY, false); //Non-Working day for rest of the world
        this.isWorkingDayMap.put(DayOfWeek.SUNDAY, false); //Non-Working day for rest of the world
    }
}
